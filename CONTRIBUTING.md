Contributing to Solarium Core
==================================

The Solarium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Solarium Core project, and is not to be
confused with overall Solarium Network Protocol consensus changes.

Whether a pull request is merged into Solarium Core rests with the project merge
...
Patches that change Solarium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Solarium consensus, it must have been
...
The project leader is the release manager for each Solarium Core release.
