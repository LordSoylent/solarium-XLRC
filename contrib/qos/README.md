...
This means one can have an always-on solariumd instance running, and another local solariumd/solarium-qt instance which connects to this node and receives blocks from it.
