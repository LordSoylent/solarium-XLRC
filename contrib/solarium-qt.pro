...
RESOURCES += src/qt/solarium.qrc src/qt/solarium_locale.qrc

TRANSLATIONS += src/qt/locale/solarium_bg.ts \
                src/qt/locale/solarium_de.ts \
                src/qt/locale/solarium_en.ts \
                src/qt/locale/solarium_es.ts \
                src/qt/locale/solarium_fi.ts \
                src/qt/locale/solarium_fr.ts \
                src/qt/locale/solarium_it.ts \
                src/qt/locale/solarium_ja.ts \
                src/qt/locale/solarium_pl.ts \
                src/qt/locale/solarium_pt.ts \
                src/qt/locale/solarium_ru.ts \
                src/qt/locale/solarium_sk.ts \
                src/qt/locale/solarium_sv.ts \
                src/qt/locale/solarium_vi.ts \
                src/qt/locale/solarium_zh_CN.ts \
                src/qt/locale/solarium_zh_TW.ts
