...
Intro
-----
Solarium (XLRC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Solarium utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run solarium-qt.exe.

Solarium Core is the original Solarium client and it builds the backbone of the network.
However, it downloads and stores the entire history of Solarium transactions;
