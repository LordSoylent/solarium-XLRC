...
This mechanism has been integrated into Bitcore-Node-Solarium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/solarium/insight-api-solarium#web-socket-api](https://github.com/solarium/insight-api-solarium#web-socket-api)
* API: [https://github.com/solarium/insight-api-solarium#swifttx-transactions](https://github.com/solarium/insight-api-solarium#swifttx-transactions)
...
By default, the Solarium Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Solarium Core daemon:
