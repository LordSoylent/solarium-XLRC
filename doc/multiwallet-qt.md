...
In order to support loading of multiple wallets in solarium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is solarium.cpp.
...
Changes to solarium.cpp
----------------------
solarium.cpp is the entry point into solarium-qt, and as such, will require some minor modifications to provide hooks for
