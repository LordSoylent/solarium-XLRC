...
#   c) node1 mines 32 blocks, so now node 0 has 500000XLRC, node 1 has 4250XLRC, node2 has none.
#   d) node0 sends 601 XLRC to node2, in two transactions (301 XLRC, then 300 XLRC).
