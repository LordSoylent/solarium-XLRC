...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Solarium Core solarium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  solarium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoin green transaction") + "\n" +
                               "  solarium-tx [options] -create [commands]   " + _("Create hex-encoded bitcoin green transaction") + "\n" +
                               "\n";
