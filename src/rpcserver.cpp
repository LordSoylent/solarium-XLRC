...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Solarium server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Solarium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Solarium features */
        {"solarium", "masternode", &masternode, true, true, false},
        {"solarium", "listmasternodes", &listmasternodes, true, true, false},
        {"solarium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"solarium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"solarium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"solarium", "masternodedebug", &masternodedebug, true, true, false},
        {"solarium", "startmasternode", &startmasternode, true, true, false},
        {"solarium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"solarium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"solarium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"solarium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"solarium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"solarium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"solarium", "mnbudget", &mnbudget, true, true, false},
        {"solarium", "preparebudget", &preparebudget, true, true, false},
        {"solarium", "submitbudget", &submitbudget, true, true, false},
        {"solarium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"solarium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"solarium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"solarium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"solarium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"solarium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"solarium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"solarium", "checkbudgets", &checkbudgets, true, true, false},
        {"solarium", "mnsync", &mnsync, true, true, false},
        {"solarium", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> solarium-cli " + methodname + " " + args + "\n";
}
