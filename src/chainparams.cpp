...
// Copyright (c) 2017 The Solarium developers
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Solarium: 1 day
        nTargetSpacing = 2 * 60;  // Solarium: 2 minutes
        nMaturity = 10;
        ...
        nLastPOWBlock = 5000;
        nModifierUpdateBlock = 1; // we use the version 2 for XLRC
         ...
         */
        const char* pszTimestamp = "Solarium ReLaunch";
        ...
        assert(genesis.hashMerkleRoot == uint256("0x49ce4759dda47fb499258656da3a5479b1d156495af2b5babe9694c89be57238"));

        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("seed1.solariumcoin.com", "seed1.solariumcoin.com"));
        vSeeds.push_back(CDNSSeedData("seed2.solariumcoin.com", "seed2.solariumcoin.com"));
        vSeeds.push_back(CDNSSeedData("seed3.solariumcoin.com", "seed3.solariumcoin.com"));
        vSeeds.push_back(CDNSSeedData("206.189.71.203", "206.189.71.203"));


        // Solarium addresses start with 'S'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 63);
        // Solarium script addresses start with 'S'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 63);
        // Solarium private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 192);
        // Solarium BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Solarium BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Solarium BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Solarium: 1 day
        nTargetSpacing = 2 * 60;  // Solarium: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        // Testnet Solarium addresses start with 's'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 48);
        // Testnet Solarium script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet Solarium BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Solarium BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Solarium: 1 day
        nTargetSpacing = 2 * 60;        // Solarium: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1524904775;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21451168;
