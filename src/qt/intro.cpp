...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Solarium Core"),
     ...
     * override -datadir in the solarium.conf file in the default data directory
     * (to be consistent with solariumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
