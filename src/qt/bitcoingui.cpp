                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Solarium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XLRC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and solarium: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Solarium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Solarium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Solarium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XLRC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XLRC addresses"));
    ...
    openAction->setStatusTip(tr("Open a solarium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Solarium Core help message to get a list with possible Solarium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Solarium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Solarium network", "", count));
}
...
{
    QString strTitle = tr("Solarium Core"); // default title
