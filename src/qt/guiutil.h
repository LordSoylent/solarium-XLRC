...
/** Utility functions used by the Solarium Qt UI.
 */
namespace GUIUtil
{
...
// Render XLRC addresses in monospace font
...
// Parse "solarium:" URI into recipient object, return true on successful parsing
